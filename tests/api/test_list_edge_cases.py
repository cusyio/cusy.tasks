...
def edge_case_db(tasks_db):
    ...
    tasks = (
        Task(summary="Regular task", owner="user", state="todo"),
        Task(summary="Empty owner task", owner="", state="todo"),
        Task(summary="None owner", owner=None, state="todo"),
        Task(summary="In progress task", owner="user", state="in progress"),
        Task(summary="Done task", owner="user", state="done"),
        Task(summary="Long summary! " * 100, owner="user", state="todo"),
        Task(summary="Special chars: -!@#", owner="user-!@#", state="todo"),
    )
