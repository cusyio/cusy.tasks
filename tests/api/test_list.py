...
def test_list_several_tasks(tasks_db):
    ...
    """
    orig = (
        Task("Update pytest section"),
        Task("Update cibuildwheel section", owner="veit"),
        Task("Update mock tests", owner="vsc", state="in progress"),
    )
...
def known_set():
    ...
    """
    return [
        Task(summary="zero", owner="veit", state="todo"),
        Task(summary="one", owner="veit", state="in progress"),
        Task(summary="two", owner="veit", state="done"),
        Task(summary="three", owner="vsc", state="todo"),
        Task(summary="four", owner="vsc", state="in progress"),
        Task(summary="five", owner="vsc", state="done"),
        Task(summary="six", state="todo"),
        Task(summary="seven", state="in progress"),
        Task(summary="eight", state="done"),
    ]
