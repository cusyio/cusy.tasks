...
def three_tasks(tasks_db):
    """Create three tasks."""
    task1 = tasks_db.add_task(Item("Update pytest section"))
    task2 = tasks_db.add_task(Item("Update cibuildwheel section"))
    task3 = tasks_db.add_task(Item("Update mock tests"))
...
def test_delete_last_task(tasks_db):
    ...
    """
    i = tasks_db.add_task(Item("Update pytest section"))
